...
ogp_site_url = f"https://canonical.com/juju/docs/content-cache-charms/{version}/"
...
html_context = {
    ...
    "product_page": "charmhub.io/content-cache",
    ...
    "github_url": "https://github.com/canonical/content-cache-operator",
...
#
html_theme_options = {
    'source_edit_link': 'https://github.com/canonical/content-cache-operator',
}
...
slug = 'juju/docs/content-cache-charms'
...
html_baseurl = f"https://canonical.com/juju/docs/content-cache-charms/{version}/"
