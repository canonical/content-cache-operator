...
[Ingress configurator](https://charmhub.io/ingress-configurator) charm. The following example sets the backend to `https://10.10.1.1:443` and the hostname to `origin.example.com`:
