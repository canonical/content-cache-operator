...
class TestLibUtils(unittest.TestCase):
    ...
    def test_select_available_tcp_congestion_control(self):
        sysctl_tcp_available_cc_path = 'some-file-does-not-exist'
        preferred = ['bbr']
        want = None
        self.assertEqual(utils.select_available_tcp_congestion_control(preferred, sysctl_tcp_available_cc_path), want)

        sysctl_tcp_available_cc_path = 'tests/unit/files/sysctl_net_tcp_available_congestion_control.txt'
        preferred = ['bbr2', 'bbr']
        want = 'bbr'
        self.assertEqual(utils.select_available_tcp_congestion_control(preferred, sysctl_tcp_available_cc_path), want)

        sysctl_tcp_available_cc_path = 'tests/unit/files/sysctl_net_tcp_available_congestion_control_bbr2.txt'
        preferred = ['bbr2', 'bbr']
        want = 'bbr2'
        self.assertEqual(utils.select_available_tcp_congestion_control(preferred, sysctl_tcp_available_cc_path), want)

        sysctl_tcp_available_cc_path = 'tests/unit/files/sysctl_net_tcp_available_congestion_control_no_bbr.txt'
        preferred = ['bbr2', 'bbr']
        want = None
        self.assertEqual(utils.select_available_tcp_congestion_control(preferred, sysctl_tcp_available_cc_path), want)
